...
- [ ] Task: Write root `README.md` per spec FR1–FR2 (game description, core loop, how to play, dev commands, offline/PWA notes, release/deploy summary, Kenney CC0 credits, both committed screenshots via relative paths)
- [ ] Task: Verify README commands match `package.json` scripts and screenshot paths resolve to committed files
- [ ] Task: Commit `docs(readme): Add project README`
- [ ] Task: Phase Verification & Checkpoint (Refer to workflow.md)
