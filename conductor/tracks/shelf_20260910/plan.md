...
- [ ] Task: Write failing tests for shelf persistence (TDD Red)
...
- [ ] Task: Implement shelf-store to pass tests (Green)
...
- [ ] Task: Commit `feat(grid): Add multi-track shelf persistence` + attach git note
